...
# -*- coding: utf-8 -*-
#
# ohno documentation build configuration file, created by
...
texinfo_documents = [
    (
        "index",
        "ohno",
        "Ohno API Documentation",
        ["Vanessa Sochat"],
        "ohno",
        "Ohno parses error messages.",
        "Miscellaneous",
    ),
]
